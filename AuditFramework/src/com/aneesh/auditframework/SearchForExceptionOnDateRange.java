...
public class SearchForExceptionOnDateRange {

	public List<ExceptionData> getExceptionList(String txnName, String startDate,
			String startTime, String endDate, String endTime, String startRowNum, String endRowNum) {
		...
		try {
			...
			sqlQueryString = "SELECT   ROW_NUM, TRANSACTION_ID, MSG_ID, BRKR_NAME, EG_NAME, MSGFLOW_NM, NODE_NM, ERROR_CD, ERROR_MSG, SERVICE_NM, SEARCH_KEY_1, SEARCH_KEY_2, SEARCH_KEY_3, SEARCH_KEY_4, SEARCH_KEY_5, CREATE_TIMESTAMP FROM ( "
							...
							+ txnName
							+ "A.CREATE_TIMESTAMP BETWEEN TO_TIMESTAMP('" + startDate
							+ " " + startTime
							+ "', 'MM/DD/YYYY HH24:MI:SS') AND TO_TIMESTAMP('"
							+ endDate + " " + endTime + "', 'MM/DD/YYYY HH24:MI:SS')"
