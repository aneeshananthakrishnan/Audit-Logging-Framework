...
public class SearchForExceptionOnSrchKeyDtRngCombo {
	...
	public List<ExceptionData> getExceptionList(String txnName, String searchKey1,
		...
		try {
			...
			String searchKeyConditions = (" B.SEARCH_KEY_1 = '" + searchKey1.trim() + "' AND "
					+ "B.SEARCH_KEY_2 = '" + searchKey2.trim() + "' AND "
					+ "B.SEARCH_KEY_3 = '" + searchKey3.trim() + "' AND "
					+ "B.SEARCH_KEY_4 = '" + searchKey4.trim() + "' AND "
					+ "B.SEARCH_KEY_5 = '" + searchKey5.trim() +"'").replaceFirst("B.SEARCH_KEY_1 = '' AND ", "")
