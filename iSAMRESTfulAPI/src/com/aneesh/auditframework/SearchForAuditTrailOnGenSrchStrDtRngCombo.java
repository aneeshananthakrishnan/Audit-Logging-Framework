...
public class SearchForAuditTrailOnGenSrchStrDtRngCombo {

	public List<EventPointData> getAuditList(String txnName, String genSearchString, String startDate, String startTime, 
		...
		try {
			...
			sqlQueryString = "SELECT ROW_NUM, TRANSACTION_ID, SERVICE_NM, SEARCH_KEY_1, SEARCH_KEY_2, SEARCH_KEY_3, SEARCH_KEY_4, SEARCH_KEY_5, BRKR_NAME, EG_NAME, MSGFLOW_NM, NODE_NM, START_TIME, END_TIME, ELAPSED_TIME, STATUS FROM ( "
					...
					+ "B.SEARCH_KEY_5, B.GENERIC_SEARCH_STRING FROM EVNTPNT_DATA_T A,"
					...
					+ txnName
					+ "A.GENERIC_SEARCH_STRING LIKE '%" + genSearchString
