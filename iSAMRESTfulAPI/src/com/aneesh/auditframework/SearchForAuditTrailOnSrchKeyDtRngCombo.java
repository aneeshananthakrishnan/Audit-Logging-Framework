...
public class SearchForAuditTrailOnSrchKeyDtRngCombo {

	public List<EventPointData> getAuditList(String txnName, String searchKey1,
			String searchKey2, String searchKey3, String searchKey4,
			String searchKey5, String startDate, String startTime, 
		...
		try {
			...
			String searchKeyConditions = (" A.SEARCH_KEY_1 = '" + searchKey1.trim() + "' AND "
											+ "A.SEARCH_KEY_2 = '" + searchKey2.trim() + "' AND "
											+ "A.SEARCH_KEY_3 = '" + searchKey3.trim() + "' AND "
											+ "A.SEARCH_KEY_4 = '" + searchKey4.trim() + "' AND "
											+ "A.SEARCH_KEY_5 = '" + searchKey5.trim() +"'").replaceFirst("A.SEARCH_KEY_1 = '' AND ", "")
																							.replaceFirst("A.SEARCH_KEY_2 = '' AND ", "")
																							.replaceFirst("A.SEARCH_KEY_3 = '' AND ", "")
																							.replaceFirst("A.SEARCH_KEY_4 = '' AND ", "")
																							.replaceFirst("AND A.SEARCH_KEY_5 = ''", "");	
			...
			sqlQueryString = "SELECT ROW_NUM, TRANSACTION_ID, SERVICE_NM, SEARCH_KEY_1, SEARCH_KEY_2, SEARCH_KEY_3, SEARCH_KEY_4, SEARCH_KEY_5, BRKR_NAME, EG_NAME, MSGFLOW_NM, NODE_NM, START_TIME, END_TIME, ELAPSED_TIME, STATUS FROM ( "
					+ "SELECT "
					+ "ROWNUM AS ROW_NUM,"
					+ "A.TRANSACTION_ID,"
					+ "A.SERVICE_NM,"
					...
					+ "CASE WHEN C.TRANSACTION_ID IS NOT NULL "
					+ "THEN 'FAIL' "
					+ "ELSE 'SUCCESS' "
					+ "END AS STATUS "
					+ "FROM ( "
					...
					+ txnName
					+ searchKeyConditions
					+ "AND A.START_TIME BETWEEN TO_TIMESTAMP('"
					+ startDate + " " + startTime
